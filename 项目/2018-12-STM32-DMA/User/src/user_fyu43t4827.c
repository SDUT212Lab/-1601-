...
/**
*name:void FYU43T4827_Add
*fun :往曲线空间中添加数据
*para:name:控件名称 val：数值
*ret :void
**/
void FYU43T4827_Add(uint8_t id,uint8_t channel,uint8_t data)
{
	USART_x_Send_String(USART_FYU43T4827,"add ");
	USART_x_Send_Num(USART_FYU43T4827,id);
	USART_x_Send_Byte(USART_FYU43T4827,',');
	USART_x_Send_Num(USART_FYU43T4827,channel);
	USART_x_Send_Byte(USART_FYU43T4827,',');
	USART_x_Send_Num(USART_FYU43T4827,data);
	USART_x_Send_String(USART_FYU43T4827,"\r\n");
}
