...
*ret :void
**/
void FYU43T4827_WriByte(uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t id,uint16_t color,\
											 uint16_t bg_color,uint8_t ailgn,uint8_t align_V,uint8_t bg_style,uint8_t byt)
{
	...
	USART_x_Send_Byte(USART_FYU43T4827,',');
	USART_x_Send_Byte(USART_FYU43T4827,'"');
	USART_x_Send_Byte(USART_FYU43T4827,byt);
	USART_x_Send_Byte(USART_FYU43T4827,'"');
	USART_x_Send_String(USART_FYU43T4827,"\r\n");
}
/**
