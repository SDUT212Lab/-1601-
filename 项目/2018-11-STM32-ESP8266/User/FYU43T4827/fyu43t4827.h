#ifndef _FYU43T4827_H
#define _FYU43T4827_H
/*head file*/
#include "stm32f10x.h"
#include "usart.h"
...
void FYU43T4827_WriByte(uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t id,uint16_t color,uint16_t bg_color,uint8_t ailgn,uint8_t align_V,uint8_t bg_style,uint8_t byt);
...
void FYU43T4827_WriNum(uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t id,uint16_t color, uint16_t bg_color,uint8_t ailgn,uint8_t align_V,uint8_t bg_style,uint16_t num);
