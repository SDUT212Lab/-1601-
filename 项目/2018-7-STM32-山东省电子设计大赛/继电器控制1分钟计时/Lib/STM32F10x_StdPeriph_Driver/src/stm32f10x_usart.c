...
/**
  * @brief  Fills each USART_ClockInitStruct member with its default value. //用默认值填入ClockInitStruct中
  * @param  USART_ClockInitStruct: pointer to a USART_ClockInitTypeDef
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg USART_FLAG_CTS:  CTS Change flag (not available for UART4 and UART5)清除发送
