...
#define ILI9325_DATA_CLK			RCC_APB2Periph_GPIOB
#define ILI9325_DATA_PORT			GPIOB
...
#define ILI9325_CS_H				GPIO_SetBits(ILI9325_CS_PORT,ILI9325_CS_PIN)
#define ILI9325_CS_L				GPIO_ResetBits(ILI9325_CS_PORT,ILI9325_CS_PIN)
#define ILI9325_BL_ON				GPIO_SetBits(ILI9325_BL_PORT,ILI9325_BL_PIN)
#define ILI9325_BL_OFF			GPIO_ResetBits(ILI9325_BL_PORT,ILI9325_BL_PIN)
