...
//在这个地方获取数据
const uint8_t test_com[5] = {0x74,0x65,0x73,0x74,0x00};
const uint8_t distance_com[4] = {0x64,0x69,0x73,0x00};
const uint8_t angle_com[4] = {0x61,0x6E,0x67,0x00};
const uint8_t start_com[6] = {0x73,0x74,0x61,0x72,0x74,0x00};
const uint8_t dir_com[4] = {0x64,0x69,0x72,0x00};
const uint8_t fashe_com[6] = {0x66,0x61,0x73,0x68,0x65,0x00}; 

uint8_t USARTLCD_DisposeData(uint8_t *data)
{
	if(strstr((char*)data,(char*)distance_com) != NULL) //比较开头发过来的信号
	{
		return 1; //返回距离信息
	}
	else if(strstr((char*)data,(char*)angle_com) != NULL) //比较开头发过来的信号
	{
		return 2;//返回角度信息
	}
	else if(strstr((char*)data,(char*)test_com) != NULL)
	{
		return 3;//返回题号信息
	}
	else if(strstr((char*)data,(char*)start_com) != NULL)
	{
		return 4;//返回开始信号
	}
	else if(strstr((char*)data,(char*)dir_com) != NULL)
	{
		return 5;//返回开始信号
	}
	else if(strstr((char*)data,(char*)fashe_com) != NULL)
	{
		return 6;//返回开始信号
	}
	return 0;
