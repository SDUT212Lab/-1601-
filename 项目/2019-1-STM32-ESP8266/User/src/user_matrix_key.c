...
uint8_t Matrix_Scan()
{
	...
	{
		R1_H;R2_L;R3_L;R4_L;
		if (C1_DATA ) { delay_ms(150); while(C1_DATA);return 1;}  else if  (C2_DATA ) { delay_ms(150);while(C2_DATA);return 2;} 
		else
		if (C3_DATA ) { delay_ms(150);while(C3_DATA);return 3;}  else if  (C4_DATA ) { delay_ms(150);while(C4_DATA);return 150;} 
		R1_L;R2_H;R3_L;R4_L;
		if (C1_DATA ) { delay_ms(150); while(C1_DATA);return 4;}   else if  (C2_DATA ) { delay_ms(150);while(C2_DATA);return 5;} 
		else
		if (C3_DATA ) { delay_ms(150);while(C3_DATA);return 6;}   else if  (C4_DATA ) { delay_ms(150);while(C4_DATA);return 11;} 
		R1_L;R2_L;R3_H;R4_L;
		if (C1_DATA ) { delay_ms(150);while(C1_DATA);return 7;}   else if  (C2_DATA ) { delay_ms(150);while(C2_DATA);return 8;} 
		else
		if (C3_DATA ) { delay_ms(150);while(C3_DATA);return 9;}   else if  (C4_DATA ) { delay_ms(150);while(C4_DATA);return 12;} 
		R1_L;R2_L;R3_L;R4_H;
		if (C1_DATA ) { delay_ms(150);while(C1_DATA);return 15;}  else if  (C2_DATA ) { delay_ms(150);while(C2_DATA);return 0;} 
		else
		if (C3_DATA ) { delay_ms(150);while(C3_DATA);return 14;}  else if  (C4_DATA ) { delay_ms(150);while(C4_DATA);return 13;}  
